...
public class Item {
  ...
  public void readThisLater(Context c) {
    ...
    Toast.makeText(c, mName + c.getString(R.string.item_willreadlater), Toast.LENGTH_SHORT)
        .show();
  }
  ...
  public void tweet(Context c, String aa) {
    ...
    tweet.putExtra(Intent.EXTRA_TEXT,
                   aa + " → " + mName + " " + mURL + c.getString(R.string.app_hashtag));
  ...
  public void selectAA(final Context c) {
    ...
    builder.setNegativeButton(c.getString(R.string.item_tweetwithoutaa),
                              new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                                    final int which) { // check
                                  // item.
                                  tweet(c, "");
                                }
                              });
