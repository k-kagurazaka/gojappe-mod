...
public class RssPager extends Fragment {
  ...
  // reload-INTENT
  // from OPML.
  public static final String ACTION_NewCatSelected = "newcat"; // used to load
  // new RSS
  ...
  RssCategory.CategoryPagerAdapter mAdapter;
  ViewPager mPager;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (OPML.shouldUPDATE(getActivity())) {
      ...
      OPML.promptUpdateDialog(getActivity());
            ...
            /*
             * Start normally. In case of EMPTY cat, it will prompt OPML-update;
             */
  ...
  public void selectCategoryName() {
    ...
    builder.setSingleChoiceItems(cseq, -1,
                         ...
                         */
                                     ...
                                     RssCategory
                                         cat =
                                         RssCategory.saveAndReturnNewCategory(getActivity(), name);
  ...
  public void initCategory(RssCategory cat) {
    category = cat;
         ...
         */
    mAdapter = new RssCategory.CategoryPagerAdapter(getFragmentManager(), category);
  ...
  // menu.add(0, MENU_SETBKMKSTATE, 0,
  // getString(R.string.reader_menusetaccessmethod));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      ...
      case MENU_SETBKMKSTATE:
        // TOAST HOWTO;;
        Toast.makeText(getActivity(), getString(R.string.howtosetfav), Toast.LENGTH_LONG)
            .show();
        return true;
  ...
  public void flipToNext(View target) {
    Log.w("flipnext", "called");
        /*
         * called from .xml resource; should flip the pager;
         */
